...
```
git clone git://github.com/xively/XivelyAndroid.git
```
...
```
git remote add upstream https://github.com/xively/XivelyAndroid
git fetch upstream
...
```
git remote add mine git@github.com:<your user name>/XivelyAndroid.git
git push mine new_feature_branch
```
Then:
- Navigate to the  repository you just pushed to (e.g. https://github.com/your-user-name/XivelyAndroid)
- Click "Pull Request"
